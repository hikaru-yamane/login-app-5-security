...
public class TimeRestContoller {
	...
	@PostMapping("/get")
	public List<Time> get(@AuthenticationPrincipal UserDetailsImpl userDetails) {
	...
	public void register(@RequestBody TimeForm form, @AuthenticationPrincipal UserDetailsImpl userDetails) {
		Integer userId = userDetails.getId();
